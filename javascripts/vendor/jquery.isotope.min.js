...
$(window).load(function() {
	...
	if ($("#thumbs").length > 0){
		var $container = $('#thumbs');
		  $container.isotope({
			itemSelector : '.portfolio-grid ul li',
			animationEngine : 'jquery',
			animationOptions: {
				duration: 250,
				easing: 'linear',
		...
		$('.filterable a').click(function(){
			  ...
			  $(".filterable li").removeClass("current");
...
$(window).load(function(){
	...
	$("#thumbs .item-info-overlay").hide();
	
	if( is_touch_device() ){
		$("#thumbs li").click(function(){
												  
			var count_before = $(this).closest("#thumbs li").prevAll("#thumbs li").length;
